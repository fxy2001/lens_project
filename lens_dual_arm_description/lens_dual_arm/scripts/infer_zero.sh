...
###
 ...
 # @LastEditTime: 2025-11-16 19:46:05
...
#node 1: dual_arm_robot_joint
log_info "ros2 run dual_arm_robot_joint robot_joint_node > ${LOG_DIR}/${current_day}/${current_date}/robot_controller.log 2>&1"
${UN_BUF} ros2 run dual_arm_robot_joint robot_joint_node >${LOG_DIR}/${current_day}/${current_date}/robot_controller.log 2>&1 &

#node 2: robot grpc server
...
# dance
log_info "ros2 run joint_controller_node joint_controller_executable > ${LOG_DIR}/${current_day}/${current_date}/robot_dance.log 2>&1"
${UN_BUF} ros2 run joint_controller_node joint_controller_executable > ${LOG_DIR}/${current_day}/${current_date}/robot_dance.log 2>&1 &
